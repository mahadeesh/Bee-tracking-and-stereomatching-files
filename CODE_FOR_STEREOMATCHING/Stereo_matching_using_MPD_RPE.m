% This is a program for stereomatching bees flying in different two camera views. 
...
% 3) (NO_REF_PTS) - predefined reference points for our experimental condition.
% 4) (DATA_INFO) - Date of the data captured.
% 5) (stereoParams_16_FEB_2017.mat) - stereo camera calibration file generated using Matlab's stereo calibration app.
% 6) (BC_stereo_cam_calib_trail_3_.mat) - stereo camera calibration file generated using Yves bouguet stereo calibration app. please see the readme file.
% 7) (myfilename4) - path of the 2D trajectories of bees from the right camera view (reference view). 
% 8) (myfilename3) - path of the 2D tracjectories of all bees flying the left camera view.
...
% 2) (MATCHING_BEE_MIN_DIST_REPROJ_ERR.mat) - The correct matching bee's ID, minimum perpendicular distance value and reprojection error value will be stored in this variable.

% See the readme file once before running this program.
...
obj_no1 = 1; obj_no2=1;    % See variable description section above
NO_REF_PTS = 8;            % See variable description section above
DATA_INFO = '16 FEB 2017'; % See variable description section above

% load the calibration files

load('SAMPLE_INPUTS_FOR_STEREOMATCHING_PROGRAM/SCI_DATA_CALIB_FILES/FEB_16_2017_STEREO_PARAMS.mat');
load('SAMPLE_INPUTS_FOR_STEREOMATCHING_PROGRAM/SCI_DATA_CALIB_FILES/BC_stereo_cam_calib_trail_3_.mat');
...
% A set of calibration reference points used in our experiments. See the readme file
% for more informtaion. 

% Give the path of the calibration reference points file.

myfilename1 = sprintf('SAMPLE_INPUTS_FOR_STEREOMATCHING_PROGRAM/SCI_DATA_CALIB_FILES/BC_16_FEB_LEFT_REF_POINTS_CAM1_BKP.txt');
...
myfilename2 = sprintf('SAMPLE_INPUTS_FOR_STEREOMATCHING_PROGRAM/SCI_DATA_CALIB_FILES/BC_16_FEB_RIGHT_REF_POINTS_CAM2_BKP.txt');
...
myfilename3 = sprintf('SAMPLE_INPUTS_FOR_STEREOMATCHING_PROGRAM/DS1_OTHER_BEES_2D_TRACK_LEFT_CAM_VIEW/J_BC_HT_CORDS_CAM_3_%s_BEE_NUMBER_%d_f100.mat',DATA_INFO,opt_act_num);
...
myfilename4 = sprintf('SAMPLE_INPUTS_FOR_STEREOMATCHING_PROGRAM/DS1_REFERENCE_BEE_2D_TRACK_RIGHT_CAM_VIEW/J_BC_HT_CORDS_CAM_2_%s_BEE_NUMBER_BEE_%d_f1.mat',DATA_INFO,beestart_no);
...
% Get start and end frame for each bee
...
if accounted_bees >= 1
    ...
    % Get the bee with minimum perpendicular distance value
...
% Get the bee with minimum RPE value
